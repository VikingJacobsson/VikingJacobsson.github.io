window.onload = function() {
    ...
    var wiii = document.getElementById("canvasWaveCont").offsetWidth*1;
    //var heee = document.getElementById("canvasWaveCont").offsetHeight;
    var heee = wiii*0.5;
    ...
    canvas.style.width = wiii;
    canvas.style.height = heee;

    ///////////////////////////////////////////////////////////////////////////

    //context.viewport(0, 0, canvas.width, canvas.height);
    context.viewport(0, 0, wiii, heee);
    context.clearColor(0.0, 0.0, 0.0, 0.0);
    context.enable(context.DEPTH_TEST);

    var persp = mat4.create();
    mat4.perspective(45.0, 0.5, 0.1, 100.0, persp);
    //mat4.perspective(10.0, 0.5, 0.1, 100.0, persp);
